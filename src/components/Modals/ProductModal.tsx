        ...
        <div className="modal-box lg:w-11/12 lg:max-w-5xl no-scrollbar  overflow-y-auto bg-white text-black ">
          ...
          {products.length > 0 ? (
            ...
            >
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="relative flex items-center">
                        <label htmlFor="shipping">จัดส่งสินค้า <span className="text-sm text-gray-500">(ค่าจัดส่ง 50.-)</span></label>
                      </div>
                    </div>
              ...
              <div className="mt-5">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <p className="text-lg font-bold text-gray-900">{total.toLocaleString()} บาท</p>
                </div>
              </div>
              <div className="mt-5">
                <button
            ...
            <div className="text-center py-6 sm:py-10">
              <p className="text-gray-600 text-xl sm:text-2xl lg:text-3xl">ไม่มีสินค้าในตะกร้า</p>
            </div>
          )}
